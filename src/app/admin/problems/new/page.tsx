        ...
        <div className="space-y-6">
            <div className="flex items-center gap-4">
                ...
                <div>
                    ...
                    <p className="text-muted-foreground">
                        Create a new coding problem for interviews
                    </p>
                </div>
            </div>
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>
                        Fill in the problem information below
                    </CardDescription>
                </CardHeader>
                <CardContent>
                    <Form {...form}>
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        ...
                                        >
                                            ...
                                            <TabsContent
                                                value="preview"
                                                className="mt-2 border rounded-md p-4 min-h-[400px] bg-muted/30 overflow-auto prose prose-sm dark:prose-invert max-w-none"
                                            >
                                                {field.value ? (
                                                    <ReactMarkdown
                                                        remarkPlugins={[
